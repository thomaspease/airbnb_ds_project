...
class TuneModel():
  def __init__(self, X, y, model, param_grid, method='grid', n_iter=20):
    ...
    self.tuned_for_mse_performance_ = self.__return_tuned_results(self.mse_tuned_model)
    self.tuned_for_r2_performance_ = self.__return_tuned_results(self.r2_tuned_model)
  ...
  def __return_tuned_results(self, model):
    data = {
